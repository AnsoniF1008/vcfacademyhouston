-- VCF Academy Houston - Database Schema
-- Run this in MySQL to create the database and tables.

CREATE DATABASE IF NOT EXISTS if0_41281527_valenciacf CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- Sedes (main parks / venues; mapa_general_url = main entrance; nota_acceso = e.g. "Use North Entrance")
CREATE TABLE sedes (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
-- Canchas (numero_cancha, optional sobrenombre e.g. "The Mestalla Pitch"; mapa_url = exact pin / Plus Code)
...
-- Categorias (age groups and training times)
...
-- Academy registration / interest form
